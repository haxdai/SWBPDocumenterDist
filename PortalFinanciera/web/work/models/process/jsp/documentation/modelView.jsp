<%-- 
    Document   : modelView
    Created on : 27/01/2014, 04:40:28 PM
    Author     : hasdai
--%>
...
<%
ProcessElement pe = (ProcessElement) SWBPlatform.getSemanticMgr().getOntology().getGenericObject(request.getParameter("suri"));
...
<ul class="list-unstyled list-inline hidden-print visible-lg text-center modelerControls">
    <li>
...
<svg id="modeler" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100" height="100" class="modeler">
    ...
    <defs id="globalDef">
        ...
        <g id="data" bclass="itemaware" oclass="itemaware_o">
            <path style="fill: #afbac7; stroke: #666666;" transform="scale(0.7,0.7) translate(-3,-10)" d="m -25,-25 0,74.61135 58.22841,0 0,-55.2509 -19.88426,-19.36045 -38.34415,0 z"/>
            <path style="fill: #afbac7; stroke: #666666;" transform="scale(0.7,0.7) translate(-2,-10)" d="m 12.5,-24 0,19.5625 20.0601,0"/>
        </g>
        <g id="dataStore" bclass="itemaware" oclass="itemaware_o" transform="translate(-12,-10)">
            <path style="fill: #afbac7; stroke: #666666;" d="m 0,0 c -27.75868,0 -50.28125,5.6228 -50.28125,12.5625 0,0.1516 0.0412,0.2871 0.0625,0.4375 l -0.0625,0 0,61.5624 0,0.3125 0.0312,0 c 0.68314,6.7909 22.92187,12.25 50.25,12.25 27.3249498,0 49.53067,-5.4602 50.21875,-12.25 l 0.0312,0 0,-0.3125 0,-61.5624 -0.0312,0 c 0.0212,-0.1501 0.0312,-0.2862 0.0312,-0.4375 0,-6.9397 -22.4913202,-12.5625 -50.25,-12.5625 z" transform="scale(0.6,0.6) translate(22,-24)"/>
            <path style="fill: #afbac7; stroke: #666666;" d="m 0,0 c 0,6.9397 -22.5028602,12.5654 -50.26153,12.5654 -27.39179,0 -49.73975,-5.4833 -50.25272,-12.33" transform="scale(0.6,0.6) translate(72,-12)"/>
        </g>	
...
<%--script type="text/javascript">
    ...
    function callbackHandler() {
        ...
        if (pe instanceof SubProcess) {
            %>
            var obj = Modeler.getGraphElementByURI(null, "<%=pe.getURI()%>");
    ...
    function resetZoom() {
        var el = document.getElementById("modeler");
        //console.log('width: ' + $("#modeler").parent().width());
        el.setAttribute('viewBox', '0 0 ' + $("#modeler").parent().width() + ' ' + $("#modeler").parent().height());
        el.setAttribute('width', '1024');
        el.setAttribute('height', '768');
        //console.log('on rZ');
