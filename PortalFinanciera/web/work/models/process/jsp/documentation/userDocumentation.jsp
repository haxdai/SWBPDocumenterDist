...
<div class="row swbp-pad">
    ...
    <div class="col-lg-3 col-lg-offset-0 col-md-4 col-md-offset-8 col-sm-4 col-sm-offset-8 col-xs-12 swbp-raised-button">
        <a href="<%= templatesUrl%>?<%= SWPUserDocumentationResource.PARAM_PROCESSGROUP %>=<%= idpg %>" class="btn btn-block swbp-btn-block" data-toggle="tooltip" data-placement="bottom" data-original-title="<%=paramRequest.getLocaleString("lblAdminTemplates")%>" title="<%=paramRequest.getLocaleString("lblAdminTemplates")%>">
...
<div class="panel panel-default swbp-panel-head">
    <div class="panel-heading text-center">PROCESOS</div>
</div>
<%
...
<div class="swbp-list-element">
    ...
    <div class="col-lg-5 col-md-5 col-sm-3 col-xs-12 swbp-list-action">
        ...
        <a class="btn btn-default col-lg-4 col-md-4 col-sm-4 col-xs-4" role="button" href="<%= captureUrl %>?idp=<%= p.getId() %>&_rid=<%=paramRequest.getResourceBase().getId()%>&wp=<%=paramRequest.getWebPage().getId()%>&<%= SWPUserDocumentationResource.PARAM_PROCESSGROUP %>=<%=idpg%>&p=<%= pag %>">
            <%}
                                                else{%><a class="btn btn-default col-lg-4 col-md-4 col-sm-4 col-xs-4" role="button" href="#" disabled="disabled"><%}%>
            ...
            <a class="btn btn-default col-lg-4 col-md-4 col-sm-4 col-xs-4" href="#" role="button">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 fa fa-trash"></div>
