...
<xsl:output method="xml" version="1.0" encoding="ISO-8859-1" omit-xml-declaration="yes" indent="yes"/>
    <xsl:template match="/">
            <div id="SWBP-MENU-PROCESO" class="panel-collapse collapse in">
                        ...
                        <HR></HR>
                            ...
                            <div class="btn-toolbar" role="toolbar">
                                <div class="btn-group swbp-toolbar-model">
                                    <a href="#" class="btn btn-default swbp-button-tool fa fa-search-plus fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Zoom in" onclick="zoomin();return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-search-plus fa-lg"></i>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool fa fa-search-minus fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Zoom out" onclick="zoomout();return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-search-minus fa-lg"></i>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool fa fa-desktop fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Reset zoom" onclick="resetZoom();return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-desktop fa-lg"></i>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool fa fa-arrow-left fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Pan left" onclick="handlePanning('left');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-arrow-left fa-lg"></i>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool fa fa-arrow-down fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Pan down" onclick="handlePanning('down');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-arrow-down fa-lg"></i>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool fa fa-arrow-up fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Pan up" onclick="handlePanning('up');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-arrow-up fa-lg"></i>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool fa fa-arrow-right fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Pan right" onclick="handlePanning('right');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-arrow-right fa-lg"></i>]]></xsl:text></a>
                                    <xsl:choose>
                                        <xsl:when test="root/@export!='true'">
                                            <a href="#" class="btn btn-default swbp-button-tool fa fa-file-image-o fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Descargar PNG" onclick="submit_download_form('png');"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-file-image-o fa-lg"></i>]]></xsl:text></a>
                                            <a href="#" class="btn btn-default swbp-button-tool fa fa-file-code-o fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Descargar SVG" onclick="submit_download_form('svg');"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-file-code-o fa-lg"></i>]]></xsl:text></a>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <a href="rep_files/{root/model/@id}.png" class="btn btn-default swbp-button-tool fa fa-file-image-o fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Descargar PNG"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-file-image-o fa-lg"></i>]]></xsl:text></a>
                                            <a href="rep_files/{root/model/@id}.svg" class="btn btn-default swbp-button-tool fa fa-file-code-o fa-lg" data-placement="bottom" data-toggle="tooltip" data-original-title="Descargar SVG"><xsl:text disable-output-escaping="yes"><![CDATA[<i class="fa fa-file-code-o fa-lg"></i>]]></xsl:text></a>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </div>
                            </div>  
