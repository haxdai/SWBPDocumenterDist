...
if (!user.isSigned()) {
    ...
    <div class="panel panel-default swbp-panel">
        <div class="panel-heading swbp-panel-title">
            <h1 class="panel-title fa fa-plus"><strong> <%=paramRequest.getLocaleString("msgAdd")%>&nbsp;<%=re != null?paramRequest.getLocaleString("msgVersionOf")+" ":""%> <%=(re != null && re instanceof RepositoryURL)?paramRequest.getLocaleString("msgDocLink"):paramRequest.getLocaleString("msgFile")%></strong></h1>
        </div>
            ...
            <div class="panel-body">
                ...
                <div class="panel-footer text-right">
                    ...
                    <!--div class="col-lg-3 text-right"-->
                        <button type="button" onclick="window.location='<%=viewURL%>';" class="btn btn-default"> <i class="fa fa-reply"></i> <%=paramRequest.getLocaleString("msgBTNCancel")%></button>
                        <button type="button" class="btn btn-success" onclick="if(checkfiles('<%=validFiles%>')){this.form.submit();} else {return false;};"><i class="fa fa-plus"></i> <%=paramRequest.getLocaleString("msgAdd")%></button>
                    <!--/div-->
                </div>
            </form>
        </div>
