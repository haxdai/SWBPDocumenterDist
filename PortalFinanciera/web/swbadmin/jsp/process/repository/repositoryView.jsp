        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="swbp-actions">
                    ...
                    <a href="<%=editUrl%>" title="<%=paramRequest.getLocaleString("msgInfo")%>" class="btn btn-default" data-toggle="modal" data-target="#modalDialog"><span class="fa fa-pencil"></span></a>
                        <%}%>
