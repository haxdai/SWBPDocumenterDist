                ...
                if (action != null && action.equals("viewPost")) {
                                    ...
                                    <h1 class="panel-title">
                                        ...
                                        if (isTheAuthor || isforumAdmin) {
                                            ...
                                            <div class="pull-right">
                                                <a href="<%=urlthread.setMode("editThread")%>" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Editar entrada"><span class="fa fa-pencil"></span></a>
                                                <a onclick="if (!confirm('¿Está seguro de querer eliminar la entrada?')) return false;" href="<%=actionURL%>" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Eliminar entrada"><span class="fa fa-trash-o"></span></a>
                                                <a href="<%=paramRequest.getRenderUrl().setMode("view")%>" data-toggle="tooltip" data-placement="bottom" class="btn btn-success" title="Volver al blog"><span class="fa fa-reply"></span></a>
                                            </div>
                                            <%
                                        }
                                        %>
                            ...
                            <div class="panel-body">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <%=autor%> - <%=SWBUtils.TEXT.getTimeAgo(thread.getCreated(), lang)%>
                                        <!--<%=thread.getCreated()%> -->
                                    </li>
                                </ul>
                                <p>
                                        ...
                                        <%=mgr.getFormHiddens()%>
                                            ...
                                            if (oforum.isCaptcha()) {
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Código de verificación *:</label>
                                                    <div class="col-lg-4">
                                                        <img src="<%=SWBPortal.getContextPath()%>/swbadmin/jsp/securecode.jsp" id="imgseccode" width="200" height="100" alt="" /><br>            
                                                        <input type="text" required class="form-control" name="cmnt_seccode" id="cmnt_seccode" maxlength="8" value="" trim="true"/>
                                                    </div>
                                                </div>
                                                <%
                                            }
                                        ...
                                        <li class="list-group-item active">
                                            ...
                                            while (itPost.hasNext()) {
                                                ...
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        <p class="text-right">
                                                            <%=postCreator%> - <%=SWBUtils.TEXT.getTimeAgo(post.getUpdated(), lang)%>
                                                        </p>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-1">
                    ...
                    <div class="row text-right">
                        <ul class="list-unstyled list-inline">
                            <li><a href="<%=webpage.getParent().getUrl(lang)%>" class="btn btn-default swbp-btn-action" data-toggle="tooltip" data-placement="bottom" title="Herramientas de colaboración"><span class="fa fa-reply fa-fw"></span></a></li>
                            <%
                            if(!oforum.isOnlyAdminCreateThreads() || isforumAdmin){
                                if(user!=null && user.isRegistered()){
                                    urlthread.setMode("addThread");
                                    %>
                                        <li><a href="<%=urlthread%>" class="btn btn-default swbp-btn-action" data-toggle="tooltip" data-placement="bottom" title="Agregar entrada"><span class="fa fa-plus fa-fw"></span></a></li>
                                    <%
                                }
                            }
                            %>
