...
public abstract class SectionElementBase extends org.semanticwb.model.SWBClass implements org.semanticwb.model.Traceable,org.semanticwb.model.Descriptiveable,org.semanticwb.model.Sortable
{
   ...
   */
    ...
    public static class ClassMgr
    {
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.process.documentation.model.SectionElement with a determined DocumentSectionInst
       * @param value DocumentSectionInst of the type org.semanticwb.process.documentation.model.DocumentSectionInstance
       * @param model Model of the org.semanticwb.process.documentation.model.SectionElement
       * @return Iterator with all the org.semanticwb.process.documentation.model.SectionElement
       */

        public static java.util.Iterator<org.semanticwb.process.documentation.model.SectionElement> listSectionElementByDocumentSectionInst(org.semanticwb.process.documentation.model.DocumentSectionInstance value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.SectionElement> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentSectionInst, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.process.documentation.model.SectionElement with a determined DocumentSectionInst
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.process.documentation.model.SectionElement> listSectionElementByDocumentSectionInst(org.semanticwb.process.documentation.model.DocumentSectionInstance value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.SectionElement> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentSectionInst,value.getSemanticObject(),sclass));
            return it;
        }
       /**
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.process.documentation.model.SectionElement with a determined DocumentTemplate
       * @param value DocumentTemplate of the type org.semanticwb.process.documentation.model.DocumentTemplate
       * @param model Model of the org.semanticwb.process.documentation.model.SectionElement
       * @return Iterator with all the org.semanticwb.process.documentation.model.SectionElement
       */

        public static java.util.Iterator<org.semanticwb.process.documentation.model.SectionElement> listSectionElementByDocumentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.SectionElement> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentTemplate, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.process.documentation.model.SectionElement with a determined DocumentTemplate
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.process.documentation.model.SectionElement> listSectionElementByDocumentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.SectionElement> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentTemplate,value.getSemanticObject(),sclass));
            return it;
        }
    }
...
*/
   ...
   */
    ...
    public void setDocumentSectionInst(org.semanticwb.process.documentation.model.DocumentSectionInstance value)
    {
        if(value!=null)
        {
   ...
   */
    public org.semanticwb.process.documentation.model.DocumentSectionInstance getDocumentSectionInst()
    {
...
*/
   ...
   */
    ...
    public void setDocumentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value)
    {
        if(value!=null)
        {
   ...
   */
    public org.semanticwb.process.documentation.model.DocumentTemplate getDocumentTemplate()
    {
